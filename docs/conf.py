...
htmlhelp_basename = 'MoodleDeveloperDocumentationdoc'
...
man_pages = [
    (master_doc, 'moodledeveloperdocumentation', u'Moodle Developer Documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MoodleDeveloperDocumentation', u'Moodle Developer Documentation Documentation',
     author, 'MoodleDeveloperDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
